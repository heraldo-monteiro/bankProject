...
public class depositoBancario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(0, 92, 169));
        ...
        jLabel6.setText("Deposito Bancário");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new depositoBancario().setVisible(true);
            }
        });
    }
